    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 offset-lg-4">
                <form action="{{ route('users.postRecover') }}" method="POST">
                    @csrf
                    <div class="sign_in__title">
                        <span>SA-BLOG</span>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @error('name') border border-danger @enderror" id="floatingInput" placeholder="Username" name="name" value="{{ $data->name }}" readonly>
                    ...
                    <button class="w-100 mb-3 btn btn-success">Cập nhật</button>
                </form>
            </div>
        </div>
    </div>
